...
This example demonstrates how to use GitFleet with Quart (async Flask) to create a web-based repository
...
providing a more elegant way to handle GitFleet's asynchronous operations without threads.

Prerequisites:
- Quart: For async web application (pip install quart)
- pandas: For data analysis (pip install pandas)
- GitFleet: With all extensions (pip install "gitfleet[all]")
"""
...
<head>
    ...
    <title>GitFleet Repository Analysis (Quart)</title>
    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col">
                ...
                <h1 class="display-4">GitFleet Repository Analysis</h1>
                <p class="lead">Web-based repository analysis tool powered by GitFleet and Quart (Async Flask)</p>
            </div>
        </div>
