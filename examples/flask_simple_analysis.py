...
This example demonstrates how to use GitFleet with Flask to create a web-based repository
...
<head>
    ...
    <title>GitFleet Repository Analysis</title>
    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col">
                ...
                <p class="lead">Web-based repository analysis tool powered by GitFleet and Flask</p>
            </div>
        </div>
